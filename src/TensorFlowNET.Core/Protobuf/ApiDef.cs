...
namespace Tensorflow {
  ...
  #endif
  {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      inArg_.WriteTo(ref output, _repeated_inArg_codec);
      outArg_.WriteTo(ref output, _repeated_outArg_codec);
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 34: {
            inArg_.AddEntriesFrom(ref input, _repeated_inArg_codec);
            break;
          }
          case 42: {
            outArg_.AddEntriesFrom(ref input, _repeated_outArg_codec);
            break;
          }
          case 50: {
          ...
          case 90: {
            argOrder_.AddEntriesFrom(ref input, _repeated_argOrder_codec);
            break;
          }
          case 98: {
            DeprecationMessage = input.ReadString();
