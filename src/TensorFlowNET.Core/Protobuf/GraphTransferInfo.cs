...
namespace Tensorflow {
  ...
  #endif
  {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      nodeInput_.WriteTo(ref output, _repeated_nodeInput_codec);
      if (_unknownFields != null) {
        _unknownFields.WriteTo(ref output);
      }
    }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 18: {
            nodeInput_.AddEntriesFrom(ref input, _repeated_nodeInput_codec);
            break;
          }
        }
      }
  ...
  #endif
  {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      maxByteSize_.WriteTo(ref output, _repeated_maxByteSize_codec);
      if (_unknownFields != null) {
        _unknownFields.WriteTo(ref output);
      }
    }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 18:
          case 16: {
            maxByteSize_.AddEntriesFrom(ref input, _repeated_maxByteSize_codec);
            break;
          }
        }
      }
  ...
  #endif
  {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      constNodeInfo_.WriteTo(ref output, _repeated_constNodeInfo_codec);
      nodeInputInfo_.WriteTo(ref output, _repeated_nodeInputInfo_codec);
      nodeOutputInfo_.WriteTo(ref output, _repeated_nodeOutputInfo_codec);
      graphInputNodeInfo_.WriteTo(ref output, _repeated_graphInputNodeInfo_codec);
      graphOutputNodeInfo_.WriteTo(ref output, _repeated_graphOutputNodeInfo_codec);
      if (Destination != global::Tensorflow.GraphTransferInfo.Types.Destination.Nop) {
        output.WriteRawTag(56);
        output.WriteEnum((int) Destination);
      }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 18: {
            constNodeInfo_.AddEntriesFrom(ref input, _repeated_constNodeInfo_codec);
            break;
          }
          case 26: {
            nodeInputInfo_.AddEntriesFrom(ref input, _repeated_nodeInputInfo_codec);
            break;
          }
          case 34: {
            nodeOutputInfo_.AddEntriesFrom(ref input, _repeated_nodeOutputInfo_codec);
            break;
          }
          case 42: {
            graphInputNodeInfo_.AddEntriesFrom(ref input, _repeated_graphInputNodeInfo_codec);
            break;
          }
          case 50: {
            graphOutputNodeInfo_.AddEntriesFrom(ref input, _repeated_graphOutputNodeInfo_codec);
            break;
          }
          case 56: {
            Destination = (global::Tensorflow.GraphTransferInfo.Types.Destination) input.ReadEnum();
